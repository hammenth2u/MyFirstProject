 ...
 */
final class Version20200311151414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE access ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE access DROP created_at, DROP updated_at');
